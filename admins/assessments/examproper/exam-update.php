...
<div class="col-md-6">
              ...
              <div class="form-group">
               ...
               <input type="text" readonly="true"  name="access_code" class="form-control" style="width: 100%;" value="<?php echo $access_code; ?>" >
...
<div class="col-md-12">
              <div class="form-group">
                <label>Description</label>
                 <textarea  readonly="true" name="description" class="form-control" style="width: 100%;" required> <?php echo $test_desc; ?></textarea>
              </div>
</div>

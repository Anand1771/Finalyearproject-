      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input type="password" id="repassword" name="repassword" required=""> 
			...
			<option value="Mechanical">Class XII</option>
			<option value="Mechanical">Class XI</option>
			<option value="Mechanical">Class X</option>
			<option value="Mechanical">Class IX</option>
			<option value="Mechanical">Class VIII</option>
			<option value="Mechanical">Class VII</option>
			<option value="Mechanical">Class VI</option>

...
$passing_rate =$_SESSION['passing_rate'];
  ...
  $stmt =  $conn->prepare("SELECT * FROM studentdata_tests as ST, questions as Q where ST.test_id = '$test_id' and ST.student_id = '$user_id' and Q.q_id = ST.q_id AND ID_PERTAKE = '$id'");
  $stmt->execute();
